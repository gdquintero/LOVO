...
# plt.plot(df_sol_5[0].values+20,df_sol_5[1].values,label="$m_{train}=5$")
plt.plot(df_sol_10[0].values+15,df_sol_10[1].values,label="$m_{train}=10$")
plt.plot(df_sol_15[0].values+10,df_sol_15[1].values,label="$m_{train}=15$")
plt.plot(df_sol_20[0].values+5,df_sol_20[1].values,label="$m_{train}=20$")
plt.plot(df_sol_25[0].values,df_sol_25[1].values,label="$m_{train}=25$")

plt.plot(t[:25],df_data[0].values[:25],"ok",alpha=0.7,ms=4)
plt.plot(t[25:],df_data[0].values[25:],"ok",mfc='none',ms=4,marker="s",alpha=0.7)
