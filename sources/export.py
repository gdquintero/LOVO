...
df= pd.read_table("output/measles_latex2.txt",delimiter=" ",header=None,skiprows=0,skipinitialspace=True)
df.to_excel("output/measles_latex2.xlsx")

df= pd.read_table("output/mumps_latex2.txt",delimiter=" ",header=None,skiprows=0,skipinitialspace=True)
df.to_excel("output/mumps_latex2.xlsx")

df= pd.read_table("output/rubella_latex2.txt",delimiter=" ",header=None,skiprows=0,skipinitialspace=True)
df.to_excel("output/rubella_latex2.xlsx")