program covid
   ...
   Open(Unit = 100, File = trim(pwd)//"/../output/inf_sup_covid.txt", ACCESS = "SEQUENTIAL")
   write(100,*) pdata%inf
   write(100,*) pdata%sup
   close(100)
   ...
   do sam = pdata%inf, pdata%sup
      ...
      Open(Unit = 200, File = trim(pwd)//"/../output/outliers_covid_cubic.txt", ACCESS = "SEQUENTIAL")
   ...
   subroutine export(pdata,fobj)
      ...
      Open(Unit = 100, File = trim(pwd)//"/../output/solutions_covid_cubic.txt", ACCESS = "SEQUENTIAL")
      Open(Unit = 200, File = trim(pwd)//"/../output/accuracy_covid_cubic.txt", ACCESS = "SEQUENTIAL")
